...
mod tests {
    ...
    struct RecordingWorkspaceRepo {
        ...
        updates: Mutex<Vec<(Uuid, String, String, OffsetDateTime, String)>>,
        update_metadata: Mutex<Vec<(Option<String>, Option<String>, Option<String>)>>,
    }
    ...
    impl RecordingWorkspaceRepo {
        ...
        fn update_calls(&self) -> Vec<(Uuid, String, String, OffsetDateTime, String)> {
            self.updates.lock().unwrap().clone()
        }

        fn update_metadata_calls(&self) -> Vec<(Option<String>, Option<String>, Option<String>)> {
