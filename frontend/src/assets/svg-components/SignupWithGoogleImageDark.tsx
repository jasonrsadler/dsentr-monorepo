export default function SignupWithGoogleImageDark(
  ...
  return (
    ...
    >
      <rect x="0.5" y="0.5" width="448" height="42" rx="3.5" fill="#131314" />
      <g transform="translate(130, 0)">
        <g clipPath="url(#clip0_710_6237)">
          <path
      ...
      <rect x="0.5" y="0.5" width="447" height="41" rx="3.5" stroke="#8E918F" />
      <defs>
