...
- Settings > Integrations: Promote visibility now derives from workspace connectionIds per personal credential, so removing one shared connection only re-enables Promote for its matching personal connection.
