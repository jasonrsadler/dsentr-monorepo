...
- Settings > Integrations: Promote visibility and guards now derive from workspace connectionIds per personal credential, preventing duplicate promotions and only re-enabling Promote when the matching workspace share is removed.
