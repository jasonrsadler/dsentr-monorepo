...
export interface EmailActionNodeProps {
  id: string
  selected: boolean
  ...
  canEdit?: boolean
  providerName: string
  ServiceComponent: ComponentType<{ nodeId: string; canEdit?: boolean }>
}
...
interface EmailActionNodeContentProps {
  id: string
  baseProps: EmailActionNodeRenderProps
  providerName: string
  ServiceComponent: ComponentType<{ nodeId: string; canEdit?: boolean }>
}
