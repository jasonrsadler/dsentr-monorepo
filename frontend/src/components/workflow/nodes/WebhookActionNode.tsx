...
interface WebhookActionNodeProps {
  id: string
  selected: boolean
...
type WebhookActionNodeRenderProps = BaseActionNodeChildrenProps<ActionNodeData>

type WebhookActionNodeContentProps = {
  id: string
  planTier?: string | null
  onRestrictionNotice?: (message: string) => void
  baseProps: WebhookActionNodeRenderProps
}

export default function WebhookActionNode({
  id,
  selected,
  planTier,
  onRestrictionNotice,
...
function WebhookActionNodeContent({
  id,
  planTier,
  onRestrictionNotice,
  baseProps
}: WebhookActionNodeContentProps) {
  const {
    selected,
    runState,
    nodeData,
