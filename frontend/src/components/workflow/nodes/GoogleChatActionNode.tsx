...
import GoogleChatAction from '../Actions/Messaging/Services/GoogleChatAction'
...
interface GoogleChatActionNodeProps {
  id: string
  selected: boolean
...
type GoogleChatActionNodeRenderProps =
  BaseActionNodeChildrenProps<ActionNodeData>

type GoogleChatActionNodeContentProps = {
  id: string
  planTier?: string | null
  onRestrictionNotice?: (message: string) => void
  baseProps: GoogleChatActionNodeRenderProps
}

export default function GoogleChatActionNode({
  id,
  selected,
  planTier,
  onRestrictionNotice,
  ...
  return (
    <BaseActionNode
      ...
      selected={selected}
      canEdit={canEdit}
      fallbackLabel="Google Chat message"
      defaultExpanded
      onRun={onRun}
      isRunning={isRunning}
...
function GoogleChatActionNodeContent({
  id,
  planTier,
  onRestrictionNotice,
  baseProps
}: GoogleChatActionNodeContentProps) {
  const {
    selected,
    runState,
    nodeData,
      ...
      <div className="p-3">
        ...
        <AnimatePresence>
          {controller.expanded && (
            ...
            >
              <GoogleChatAction nodeId={id} canEdit={effectiveCanEdit} />
