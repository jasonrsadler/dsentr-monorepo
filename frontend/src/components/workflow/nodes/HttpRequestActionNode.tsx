...
type HttpRequestActionNodeContentProps = {
  id: string
  baseProps: HttpRequestActionNodeRenderProps
}

export default function HttpRequestActionNode({
  id,
  selected,
  onRun,
  isRunning,
...
function HttpRequestActionNodeContent({
  id,
  baseProps
}: HttpRequestActionNodeContentProps) {
  const {
    selected,
    runState,
    nodeData,
