...
interface MailgunRegionDropdownProps {
  value: string
  onChange: (value: string) => void
}

const regions = ['US (api.mailgun.net)', 'EU (api.eu.mailgun.net)']

export default function MailgunRegionDropdown({
  value,
  onChange
}: MailgunRegionDropdownProps) {
