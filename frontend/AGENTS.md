...
- OAuth connection snapshots now include Slack personal authorization state so Settings and the Slack action share a single source of truth for post-as-user availability.
