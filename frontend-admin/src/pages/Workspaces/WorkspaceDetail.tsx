    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h2 className="text-xl font-bold text-slate-100">{workspace?.workspace.name ?? id}</h2>
          <div className="text-xs text-slate-500">
            Plan: {workspace?.workspace.plan} | Owner: {workspace?.workspace.owner_id}
          </div>
        </div>
        <div className="pill">
          Member limit {workspace?.quotas.member_limit} | Run limit {workspace?.quotas.run_limit}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="card">
          <div className="mb-2 text-sm font-semibold text-slate-200">Members</div>
          <Table
            data={members}
            columns={[
        ...
        <div className="card">
          <div className="mb-2 text-sm font-semibold text-slate-200">Invites</div>
          <Table
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="card">
          <div className="mb-2 text-sm font-semibold text-slate-200">Connections</div>
          <Table
        ...
        <div className="card">
          <div className="mb-2 text-sm font-semibold text-slate-200">Workflows</div>
          <Table
