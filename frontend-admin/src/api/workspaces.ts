...
export function getWorkspaceWorkflows(workspaceId: string): Promise<WorkflowSummary[]> {
  return adminGet(`/workspaces/${workspaceId}/workflows`);
}

export function getWorkspaceIssues(workspaceId: string): Promise<IssueSummary[]> {
