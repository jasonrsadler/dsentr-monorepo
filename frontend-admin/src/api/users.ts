...
export async function listUsers(params: UserListParams): Promise<PaginatedResponse<AdminUser>> {
...
export async function getUserWorkspaces(userId: string): Promise<WorkspaceMembershipSummary[]> {
